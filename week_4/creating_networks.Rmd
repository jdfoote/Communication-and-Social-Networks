...
Hint: You will want to use [geom_node_text](https://ggraph.data-imaginist.com/reference/geom_node_text.html) and the "aesthetics" for [geom_node_point](https://ggraph.data-imaginist.com/reference/geom_node_point.html); see if you can figure out the examples.
