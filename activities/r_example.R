...
# You should have already installed tidyverse, but if Rstudio complains that tidyverse isn't installed then you need to run: 
...
# Again, run this if it isn't installed yet: 
...
select(flights, carrier, minutes_late=arr_delay)
