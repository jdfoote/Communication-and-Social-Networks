...
In this tutorial, I'm going to introduce you to two of my favorite packages for working with and visualizing networks - [tidygraph](tidygraph.data-imaginist.com/) and [ggraph]([ggraph.data-imaginist.com/), both developed by [Thomas Lin Pederson](https://www.data-imaginist.com/).
